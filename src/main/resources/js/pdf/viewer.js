...
var FindStates = {
  ...
  PDFJS.imageResourcesPath = contextPath + '/download/resources/com.xpandit.plugins.linkpreview-confluence/js/pdf/images/';
  PDFJS.workerSrc = contextPath + '/download/resources/com.xpandit.plugins.linkpreview-confluence/js/pdf/pdf.worker.js';
  PDFJS.cMapUrl = contextPath + '/download/resources/com.xpandit.plugins.linkpreview-confluence/js/pdf/cmaps/';
